...
export class MenuSidebarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.userService.getUserCompany().subscribe((userCompanyData: any) => {
            if (userCompanyData.ok) {
                this.companyService
                    .getCompanyById(userCompanyData.userCompany.company)
                    .subscribe((companyData: any) => {
                        if (companyData.ok) this.company = companyData.company;
                        this.getRoles();
                    });
            }
        });
    ...
    getRoles() {
        this.roleService.getRoles().subscribe((rolesData: any) => {
            if (rolesData.ok) {
                    ...
                    this.userService
                        ...
                        .subscribe((userRolesData: any) => {
                            if (userRolesData.ok) {
                                ...
                                this.rolesString =
                                    new DataHelper().convertArrayToChainString(
                                        arrayRoles
                                    );
                            }
                        });
