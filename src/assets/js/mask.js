...
!(function (e) {
    ...
    (r.prototype = {
            ...
            (this.tests = []),
                ...
                (this.buffer = e.map(
                    ...
                    e.proxy(function (e, n) {
                        if (e != '?')
                            return t[e] ? this.options.placeholder : e;
                    }, this)
                )),
        ...
        listen: function () {
            ...
            var t =
                (navigator.userAgent.match(/msie/i) ? 'paste' : 'input') +
                '.mask';
            this.$element
        ...
        keypressEvent: function (e) {
            ...
            if (n) {
                r.end - r.begin !== 0 &&
                    (this.clearBuffer(r.begin, r.end),
                    this.shiftL(r.begin, r.end - 1));
        ...
        checkVal: function (e) {
            ...
            if (!e && r + 1 < this.partialPosition)
                ...
                this.writeBuffer(),
                    e ||
                        this.$element.val(
                            this.$element.val().substring(0, r + 1)
                        );
