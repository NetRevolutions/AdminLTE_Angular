    ...
    var AdminMenu = (function ($) {
        ...
        var AdminMenu = (function () {
            ...
            AdminMenu.prototype._show = function _show(element) {
                ...
                _el.parent(this._config.parentTrigger).addClass(
                    this._config.activeClass
                );
                ...
                _el.removeClass(this._config.collapseClass)
            ...
            AdminMenu.prototype._hide = function _hide(element) {
                ...
                _el.parent(this._config.parentTrigger).removeClass(
                    this._config.activeClass
                );
                _el.height(_el.height())[0].offsetHeight;

                _el.addClass(this._config.collapsingClass)
