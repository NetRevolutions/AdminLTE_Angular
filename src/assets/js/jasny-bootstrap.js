...
+(function ($) {
    ...
    (Fileinput.prototype.listen = function () {
        ...
        $(this.$input[0].form).on(
            'reset.bs.fileinput',
            $.proxy(this.reset, this)
        );

        this.$element
            .find('[data-trigger="fileinput"]')
            .on('click.bs.fileinput', $.proxy(this.trigger, this));
        this.$element
            .find('[data-dismiss="fileinput"]')
            .on('click.bs.fileinput', $.proxy(this.clear, this));
    }),
        (Fileinput.prototype.change = function (e) {
            ...
            if (
                ...
                (typeof file.type !== 'undefined'
                    ...
                    : file.name.match(/\.(gif|png|jpe?g)$/i)) &&
